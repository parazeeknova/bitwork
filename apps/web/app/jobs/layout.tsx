        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
          <div className="flex items-center gap-6">
            ...
            <nav className="hidden items-center gap-6 border-[#2D4A3E]/15 border-l pl-4 md:flex">
              <Link
                className="font-medium font-mono text-[#2D4A3E] text-xs uppercase tracking-wider"
                href="/jobs"
              >
                Task Board
              </Link>
              <Link
                className="font-mono text-[#414240]/60 text-xs uppercase tracking-wider transition-colors hover:text-[#2D4A3E]"
                href="/providers"
              >
                Providers
              </Link>
